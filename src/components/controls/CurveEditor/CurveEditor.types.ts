...
/**
 * Curve / keyframe data model. Defined in `@/types/keyframe` (shared with
 * Timeline) and re-exported here so CurveEditor's public API is unchanged.
 */
export type { CurveKeyframe, CurveData, TangentMode };
