// src/controls/NumberInput/NewNumberInput.tsx
...
/**
 * Props specific to NewNumberInput component
 */
...
/**
 * Props for the NewNumberInput component with prettified type for better IntelliSense
 */
 ...
 * ```
 */
export const NewNumberInput = React.forwardRef<HTMLInputElement, NewNumberInputProps>(({
  // Value props
  value,
  onChange,
  
  // NewNumberInput specific props
  unit,
  ...
  const {
    ...
    ...(allowEx pressions !== undefined && { allowExpressions }),
  ...
  const effectiveError = error || !!errorMessage || !!externalError || !!internalError;
...
NewNumberInput.displayName = 'NewNumberInput';
