...
const meta: Meta<typeof Spacer> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A flexible spacer component that expands to fill available space or provides fixed spacing in flex layouts.',
      },
    },
  },
  argTypes: {
...
export const VerticalSpacing: Story = {
  render: () => (
    <div style={{ border: '1px dashed rgba(255, 255, 255, 0.3)', padding: '1rem', height: '200px' }}>
