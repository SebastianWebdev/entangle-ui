 ...
 * 
 * A standard gear/cog icon commonly used for settings, configuration,
 * and preferences in editor interfaces and applications.
 * 
 * @example
 * ```tsx
 * // Basic usage
 ...
 * ```
 */
export const SettingsIcon: React.FC<Omit<IconProps, 'svg'>> = (props) => {
  return (
    <Icon
