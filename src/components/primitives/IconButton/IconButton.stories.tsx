...
const meta: Meta<typeof IconButton> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A specialized square button component for icons. Always maintains square proportions and scales appropriately with icon sizes. Perfect for toolbars, quick actions, and icon-based interfaces.',
      },
    },
  },
  argTypes: {
...
export const AllSizes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'All available sizes shown together. Notice how buttons remain perfectly square.',
      },
    },
  },
};
...
export const AllVariants: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'All visual variants available for different contexts and emphasis levels.',
      },
    },
  },
};
...
export const AllRadiusOptions: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'All border radius options from sharp corners to fully circular buttons.',
      },
    },
  },
};
...
export const ToolbarExample: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Example toolbar using small icon buttons with slight rounding for a compact, professional look.',
      },
    },
  },
};
...
export const ActionButtonsExample: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
      ...
      <IconButton variant="default" radius="md" aria-label="Edit content">
        <EditIcon />
      </IconButton>

      <IconButton variant="ghost" radius="full" aria-label="Close dialog">
        <CloseIcon />
      </IconButton>
    </div>
  ),
  parameters: {
    docs: {
      description: {
        story:
          'Examples of action buttons with different combinations of variants and radius for various contexts.',
      },
    },
  },
};
...
export const InteractiveToggle: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Interactive toggle buttons showing pressed states for different UI controls.',
      },
    },
  },
};
