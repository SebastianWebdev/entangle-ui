...
- [`useEventCallback`](/hooks/use-event-callback) — stable callback identity that always invokes the latest version
...
- [`useIsMounted`](/hooks/use-is-mounted) — stable getter for whether the component is still mounted
