...
description: Stable callback identity that always invokes the most recently rendered version.
---

import ComponentPreview from '../../../components/ComponentPreview.astro';
import UseEventCallbackDemo from '../../../components/demos/hooks/UseEventCallbackDemo';
...
<ComponentPreview title="Live preview">
  <UseEventCallbackDemo client:only="react" />
</ComponentPreview>
