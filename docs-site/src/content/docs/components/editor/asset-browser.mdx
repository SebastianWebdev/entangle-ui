...
import AssetBrowserDemo, {
  ...
  AssetBrowserStates,
  AssetBrowserErrorState,
  AssetBrowserContextMenus,
  AssetBrowserMutations,
  AssetBrowserHistory,
  AssetBrowserLocalized,
...
<ComponentPreview title="Back / forward history">
  <AssetBrowserHistory client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Right-click menus (item + empty area)">
  <AssetBrowserContextMenus client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Rename, duplicate, delete, new folder">
  <AssetBrowserMutations client:only="react" />
</ComponentPreview>
...
> Mutation affordances (inline rename, the `F2` / `Delete` / `Ctrl+D` shortcuts) are **grid-view** features. The list view keeps its `DataTable` behaviour; the context-menu actions work in both.
...
<ComponentPreview title="Error state with Retry">
  <AssetBrowserErrorState client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Localized labels (Polish)">
  <AssetBrowserLocalized client:only="react" />
</ComponentPreview>
...
<PropsTable
  props={[
    ...
    },
    {
      ...
      default: 'false',
      description:
        'Enable Back/Forward controls + Backspace/Alt+ArrowUp to parent.',
    },
    {
      name: 'marquee',
      type: 'boolean',
      default: 'true',
      description:
        'Rubber-band marquee in empty grid space (multi-select only).',
    },
    {
      name: 'columns',
    ...
    },
    {
      ...
      type: '(items, actions) => ReactNode',
      description:
        'Body of the item context menu. `actions` wires rename/delete/duplicate.',
    },
    {
    ...
    {
      name: 'defaultItemActions',
      type: 'boolean',
      default: 'false',
      description:
        'Auto-build Rename/Duplicate/Delete/New-folder menu entries from the mutation callbacks.',
    },
    {
      name: 'onItemRename',
      type: '(item, newName) => boolean | void | Promise<…>',
      description:
        'Inline-rename commit. Enables F2 / rename action. Return false to reject.',
    },
    {
      name: 'onItemsDelete',
      type: '(items) => void',
      description: 'Delete intent. Enables the Delete key + default action.',
    },
    {
      name: 'onItemsDuplicate',
      type: '(items) => void',
      description: 'Duplicate intent. Enables Ctrl/Cmd+D + default action.',
    },
    {
      name: 'onCreateFolder',
      type: '(parentFolderId) => void',
      description:
        'Create-folder intent. Enables the empty-area New-folder action.',
    },
    {
      name: 'loading',
      type: 'boolean',
    ...
    },
    {
      ...
      description:
        'true → built-in error message; a node replaces it. Takes precedence over loading/empty.',
    },
    {
      name: 'onErrorRetry',
      type: '() => void',
      description: 'Adds a Retry button to the built-in error state.',
    },
    {
      name: 'labels',
      type: 'Partial<AssetBrowserLabels>',
      description:
        'Override any built-in UI string (i18n). Merged onto the English defaults.',
    },
    {
      name: 'virtualized',
      type: "boolean | 'auto'",
