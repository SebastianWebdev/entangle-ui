...
import ViewportGizmoDemo, {
  ViewportGizmoOrientation,
  ViewportGizmoUpAxis,
  ViewportGizmoAxisColors,
  ViewportGizmoInteractionModes,
  ViewportGizmoVisualOptions,
  ViewportGizmoOrbitConfig,
  ViewportGizmoEvents,
  ViewportGizmoSizes,
} from '../../../../components/demos/editor/ViewportGizmoDemo';
...
<ComponentPreview title="Live Preview">
  <ViewportGizmoDemo client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Orientation">
  <ViewportGizmoOrientation client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Up Axis Convention">
  <ViewportGizmoUpAxis client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Axis Colors">
  <ViewportGizmoAxisColors client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Interaction Modes">
  <ViewportGizmoInteractionModes client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Visual Options">
  <ViewportGizmoVisualOptions client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Orbit Configuration">
  <ViewportGizmoOrbitConfig client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Event Callbacks">
  <ViewportGizmoEvents client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Size and Diameter">
  <ViewportGizmoSizes client:only="react" />
</ComponentPreview>
...
<PropsTable
  props={[
    ...
    },
    {
      ...
      default: 'false',
      description:
        'Flip the horizontal orbit direction. Emits the opposite deltaYaw sign so the camera turns the other way for the same gesture.',
    },
    {
      name: 'invertPitch',
      type: 'boolean',
      default: 'false',
      description:
        'Flip the vertical orbit direction. Emits the opposite deltaPitch sign (dragging up turns the camera down).',
    },
    {
      name: 'onOrbit',
