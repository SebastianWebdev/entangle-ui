...
<PropsTable
  props={[
    ...
    },
    {
      name: 'leading',
      type: 'ReactNode',
      description: 'Leading visual (icon, Avatar) rendered to the left of the text column.',
    },
    {
      name: 'trailing',
      type: 'ReactNode',
      description: 'Trailing slot (IconButton, Menu) rendered to the right of the text column.',
    },
    {
      name: 'children',
      type: 'ReactNode',
  ...
  props={[
    {
      name: 'children',
      type: 'ReactNode',
      description: 'Body content. Flex-grows so the footer stays pinned to the bottom of the card.',
    },
  ]}
/>
