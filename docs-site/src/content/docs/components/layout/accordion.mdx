...
import AccordionDemo, {
  ...
  AccordionKeepMounted,
  AccordionDisabledItem,
  AccordionControlled,
} from '../../../../components/demos/layout/AccordionDemo';
...
<ComponentPreview title="Width">
  <AccordionWidth client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Single vs Multiple">
  <AccordionSingleMultiple client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Collapsible">
  <AccordionCollapsible client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Variants">
  <AccordionVariants client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Sizes">
  <AccordionSizes client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Gap">
  <AccordionGap client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Trigger with Icon and Actions">
  <AccordionTriggerExtras client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Custom Indicator">
  <AccordionCustomIndicator client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Keep Content Mounted">
  <AccordionKeepMounted client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Disabled Items">
  <AccordionDisabledItem client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Controlled Mode">
  <AccordionControlled client:only="react" />
</ComponentPreview>
...
<PropsTable
  props={[
    ...
    },
    {
      ...
      default: "'100%'",
      description:
        'Width of the accordion. Number → px, string → CSS value. Defaults to filling the parent so layout stays stable regardless of which item is expanded.',
    },
    {
      name: 'onChange',
