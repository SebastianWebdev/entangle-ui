...
<Accordion defaultValue="transform">
  ...
  <AccordionItem value="material">
    ...
    <AccordionContent>
      Color, texture, and shader settings...
    </AccordionContent>
  </AccordionItem>
</Accordion>
```
...
{/* No indicator */}
<AccordionTrigger indicator={null}>
  No Chevron
</AccordionTrigger>
```
...
<Accordion multiple value={expanded} onChange={(val) => setExpanded(val as string[])}>
  ...
</Accordion>
```
...
<PropsTable props={[
  { name: 'children', type: 'ReactNode', description: 'AccordionItem children. Required.' },
  { name: 'value', type: 'string | string[]', description: 'Controlled expanded item(s). String for single mode, string array for multiple mode.' },
  { name: 'defaultValue', type: 'string | string[]', description: 'Default expanded item(s) for uncontrolled mode.' },
  { name: 'multiple', type: 'boolean', default: 'false', description: 'Whether multiple items can be expanded simultaneously.' },
  { name: 'collapsible', type: 'boolean', default: 'false', description: 'Whether all items can be collapsed in single mode. When false, one item must remain open.' },
  { name: 'variant', type: "'default' | 'ghost' | 'filled'", default: "'default'", description: 'Visual variant applied to all accordion headers.' },
  { name: 'size', type: "'sm' | 'md' | 'lg'", default: "'md'", description: 'Size controlling header and content density.' },
  { name: 'gap', type: 'number', default: '0', description: 'Gap between accordion items in pixels.' },
  { name: 'onChange', type: '(value: string | string[]) => void', description: 'Callback when expanded items change. Returns a string in single mode, string array in multiple mode.' },
  ...
  { name: 'ref', type: 'Ref<HTMLDivElement>', description: 'Ref to the root div element.' },
]} />

### AccordionItem

<PropsTable props={[
  { name: 'value', type: 'string', description: 'Unique identifier for this item. Must match the value used in Accordion\'s value/defaultValue. Required.' },
  { name: 'disabled', type: 'boolean', default: 'false', description: 'Whether this item is disabled (cannot be expanded or collapsed).' },
  { name: 'children', type: 'ReactNode', description: 'AccordionTrigger and AccordionContent children. Required.' },
  { name: 'className', type: 'string', description: 'Additional CSS class names.' },
  { name: 'style', type: 'CSSProperties', description: 'Inline styles.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
  { name: 'ref', type: 'Ref<HTMLDivElement>', description: 'Ref to the item div element.' },
]} />

### AccordionTrigger

<PropsTable props={[
  { name: 'children', type: 'ReactNode', description: 'Header content, typically a text label. Required.' },
  { name: 'icon', type: 'ReactNode', description: 'Icon element displayed before the label.' },
  { name: 'actions', type: 'ReactNode', description: 'Action elements rendered on the right side of the header. Clicks on actions do not toggle the accordion.' },
  { name: 'indicator', type: 'ReactNode | null', description: 'Custom chevron indicator element. Pass null to hide the indicator entirely.' },
  { name: 'className', type: 'string', description: 'Additional CSS class names.' },
  { name: 'style', type: 'CSSProperties', description: 'Inline styles.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
  { name: 'ref', type: 'Ref<HTMLButtonElement>', description: 'Ref to the trigger button element.' },
]} />

### AccordionContent

<PropsTable props={[
  { name: 'children', type: 'ReactNode', description: 'Collapsible content. Required.' },
  { name: 'keepMounted', type: 'boolean', default: 'false', description: 'Whether to keep content in the DOM when collapsed. Useful for preserving form state.' },
  { name: 'className', type: 'string', description: 'Additional CSS class names.' },
  { name: 'style', type: 'CSSProperties', description: 'Inline styles.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
  { name: 'ref', type: 'Ref<HTMLDivElement>', description: 'Ref to the content body div element.' },
]} />
