...
import PageHeaderDemo, {
  PageHeaderBasic,
  PageHeaderWithActions,
  PageHeaderWithBreadcrumbs,
  PageHeaderSizes,
  PageHeaderBorderless,
} from '../../../../components/demos/layout/PageHeaderDemo';
...
<ComponentPreview title="Basic">
  <PageHeaderBasic client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="With actions">
  <PageHeaderWithActions client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="With breadcrumbs">
  <PageHeaderWithBreadcrumbs client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Sizes">
  <PageHeaderSizes client:only="react" />
</ComponentPreview>
...
<ComponentPreview
  title="Inside a bordered container"
  description="The header's own bottom border is hidden so the outer container's border reads as the boundary."
>
  <PageHeaderBorderless client:only="react" />
</ComponentPreview>
