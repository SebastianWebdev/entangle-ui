...
import DividerDemo from '../../../../components/demos/layout/DividerDemo';
...
A vertical divider needs a parent that gives it a non-zero cross-axis size — typically a flex row.
