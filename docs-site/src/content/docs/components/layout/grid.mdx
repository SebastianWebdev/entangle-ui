...
<PropsTable props={[
  { name: 'children', type: 'ReactNode', description: 'Grid content -- Grid items or any React elements. Required.' },
  { name: 'container', type: 'boolean', default: 'false', description: 'Whether this Grid acts as a container enabling CSS Grid layout.' },
  { name: 'columns', type: 'number', default: '12', description: 'Total number of columns in the grid. Only applies to containers.' },
  { name: 'spacing', type: '0 | 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8', default: '2', description: 'Gap between grid items as a multiplier of the 4px base unit. Only applies to containers.' },
  { name: 'gap', type: 'string | number', description: 'Custom gap override as a CSS value. Overrides the spacing prop when provided.' },
...
<PropsTable props={[
  { name: 'children', type: 'ReactNode', description: 'Item content. Required.' },
  { name: 'size', type: "1-12 | 'auto'", description: 'Number of columns to span (out of the total column count).' },
  { name: 'xs', type: "1-12 | 'auto'", description: 'Column span at extra-small breakpoint (0px+).' },
  { name: 'sm', type: "1-12 | 'auto'", description: 'Column span at small breakpoint (576px+).' },
  { name: 'md', type: "1-12 | 'auto'", description: 'Column span at medium breakpoint (768px+).' },
  { name: 'lg', type: "1-12 | 'auto'", description: 'Column span at large breakpoint (992px+).' },
  { name: 'xl', type: "1-12 | 'auto'", description: 'Column span at extra-large breakpoint (1200px+).' },
  { name: 'className', type: 'string', description: 'Additional CSS class names.' },
  { name: 'style', type: 'CSSProperties', description: 'Inline styles.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
  { name: 'ref', type: 'Ref<HTMLDivElement>', description: 'Ref to the underlying div element.' },
