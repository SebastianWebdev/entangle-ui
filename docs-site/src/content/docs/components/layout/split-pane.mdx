...
<SplitPane
  panels={[
    { minSize: 150, collapsible: true, collapseThreshold: 50 },
    {},
  ]}
>
...
<PropsTable props={[
  { name: 'children', type: 'ReactNode', description: 'SplitPanePanel children (minimum 2). Required.' },
  { name: 'direction', type: "'horizontal' | 'vertical'", default: "'horizontal'", description: 'Layout direction. Horizontal places panels side by side, vertical stacks them.' },
  { name: 'panels', type: 'PanelConfig[]', default: '[]', description: 'Array of panel configuration objects defining default size, min/max constraints, and collapse behavior.' },
  { name: 'sizes', type: 'number[]', description: 'Controlled panel sizes in pixels. When provided, the component operates in controlled mode.' },
  { name: 'dividerSize', type: 'number', default: '4', description: 'Divider width (horizontal) or height (vertical) in pixels.' },
  { name: 'onResize', type: '(sizes: number[]) => void', description: 'Callback fired continuously during drag with the current panel sizes.' },
  { name: 'onResizeEnd', type: '(sizes: number[]) => void', description: 'Callback fired when a drag ends. Useful for persisting layout to storage.' },
  { name: 'onCollapseChange', type: '(panelIndex: number, collapsed: boolean) => void', description: 'Callback fired when a collapsible panel collapses or expands.' },
  ...
  { name: 'ref', type: 'Ref<HTMLDivElement>', description: 'Ref to the container div element.' },
]} />
...
<PropsTable props={[
  { name: 'defaultSize', type: 'number | string', description: 'Initial panel size in pixels (number) or as a CSS value (e.g. "30%").' },
  { name: 'minSize', type: 'number', description: 'Minimum panel size in pixels.' },
  { name: 'maxSize', type: 'number', description: 'Maximum panel size in pixels.' },
  { name: 'collapsible', type: 'boolean', default: 'false', description: 'Whether this panel can collapse to zero size.' },
  { name: 'collapseThreshold', type: 'number', description: 'Size in pixels below which the panel snaps to collapsed. Defaults to minSize / 2.' },
]} />
...
<PropsTable props={[
  ...
  { name: 'style', type: 'CSSProperties', description: 'Inline styles.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
  { name: 'ref', type: 'Ref<HTMLDivElement>', description: 'Ref to the panel div element.' },
]} />
