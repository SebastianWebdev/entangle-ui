...
<PanelSurface size="md" bordered>
  <PanelSurface.Header
    actions={
      <IconButton icon={<CloseIcon />} size="sm" variant="ghost" />
    }
  >
    Transform
  </PanelSurface.Header>
...
<PropsTable props={[
  { name: 'children', type: 'ReactNode', description: 'Panel content. Typically PanelSurface.Header, PanelSurface.Body, and optionally PanelSurface.Footer.' },
  { name: 'size', type: "'sm' | 'md' | 'lg'", default: "'md'", description: 'Visual density for header and footer chrome. Shared via context to sub-components.' },
  { name: 'bordered', type: 'boolean', default: 'true', description: 'Whether to show a border around the panel.' },
  { name: 'background', type: 'string', description: 'Custom background color or gradient. Defaults to the theme secondary background.' },
...
<PropsTable props={[
  { name: 'children', type: 'ReactNode', description: 'Header content such as a title or label.' },
  { name: 'actions', type: 'ReactNode', description: 'Action elements rendered on the right side of the header (e.g. icon buttons).' },
  { name: 'className', type: 'string', description: 'Additional CSS class names.' },
  { name: 'style', type: 'CSSProperties', description: 'Inline styles.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
  { name: 'ref', type: 'Ref<HTMLDivElement>', description: 'Ref to the header div element.' },
]} />
...
<PropsTable props={[
  ...
  { name: 'scroll', type: 'boolean', default: 'false', description: 'Enables automatic overflow scrolling for the body area.' },
  { name: 'padding', type: 'number | string', default: '0', description: 'Inner padding of the body area. Numbers are treated as pixels.' },
  { name: 'className', type: 'string', description: 'Additional CSS class names.' },
  { name: 'style', type: 'CSSProperties', description: 'Inline styles.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
  { name: 'ref', type: 'Ref<HTMLDivElement>', description: 'Ref to the body div element.' },
]} />

### PanelSurface.Footer

<PropsTable props={[
  { name: 'children', type: 'ReactNode', description: 'Footer content such as action buttons.' },
  { name: 'className', type: 'string', description: 'Additional CSS class names.' },
  { name: 'style', type: 'CSSProperties', description: 'Inline styles.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
  { name: 'ref', type: 'Ref<HTMLDivElement>', description: 'Ref to the footer div element.' },
]} />
