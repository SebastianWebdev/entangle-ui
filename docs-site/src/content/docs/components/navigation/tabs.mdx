...
<Tabs defaultValue="scene">
  <TabList>
    <Tab value="scene" icon={<SceneIcon />}>Scene</Tab>
    <Tab value="render" icon={<RenderIcon />}>Render</Tab>
  </TabList>
  ...
</Tabs>
```
...
<PropsTable props={[
  { name: 'value', type: 'string', description: 'Currently active tab value (controlled).' },
  { name: 'defaultValue', type: 'string', description: 'Default active tab (uncontrolled).' },
  { name: 'variant', type: "'underline' | 'pills' | 'enclosed'", default: "'underline'", description: 'Visual variant of the tab list.' },
  ...
  { name: 'fullWidth', type: 'boolean', default: 'false', description: 'Whether tabs fill the available width equally.' },
  { name: 'pillsFrame', type: 'boolean', default: 'true', description: 'Whether pills variant renders a framed container.' },
...
<PropsTable props={[
  { name: 'value', type: 'string', description: 'Unique value identifying this tab. Must match a TabPanel value.' },
  ...
  { name: 'disabled', type: 'boolean', default: 'false', description: 'Whether this tab is disabled.' },
  { name: 'closable', type: 'boolean', default: 'false', description: 'Whether this tab shows a close button.' },
  { name: 'onClose', type: '(value: string) => void', description: 'Callback when the close button is clicked.' },
  { name: 'className', type: 'string', description: 'Additional CSS class names.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
]} />
...
<PropsTable props={[
  { name: 'value', type: 'string', description: 'Value matching a Tab value.' },
  { name: 'children', type: 'ReactNode', description: 'Panel content, only rendered when active.' },
  { name: 'keepMounted', type: 'boolean', default: 'false', description: 'Whether to keep the panel mounted when inactive (preserves state).' },
  { name: 'className', type: 'string', description: 'Additional CSS class names.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
]} />
