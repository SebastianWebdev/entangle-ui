...
import StatusBarDemo from '../../../../components/demos/shell/StatusBarDemo';
...
<ComponentPreview title="Live Preview">
  <StatusBarDemo client:only="react" />
</ComponentPreview>
  ...
  props={[
    {
      ...
      type: "'sm' | 'md'",
      default: "'sm'",
      description: 'Size of the status bar.',
    },
    {
      name: 'variant',
      type: "'default' | 'error' | 'accent'",
      default: "'default'",
      description: 'Color variant indicating application state.',
    },
    {
      name: 'children',
      type: 'ReactNode',
      description: 'StatusBar.Section components.',
    },
    {
      name: 'className',
      type: 'string',
  ...
  props={[
    {
      ...
      type: "'left' | 'right'",
      default: "'left'",
      description: 'Which side of the status bar the section aligns to.',
    },
    {
      name: 'children',
      type: 'ReactNode',
      description: 'StatusBar.Item components.',
    },
    {
      name: 'className',
      type: 'string',
    ...
    },
    {
      name: 'ref',
      type: 'Ref<HTMLDivElement>',
      description: 'Ref to the section element.',
    },
  ]}
/>
...
<PropsTable
  props={[
    ...
    },
    {
      ...
      type: '() => void',
      description:
        'Click handler. When provided, the item renders as a button instead of a span.',
    },
    {
      name: 'title',
      type: 'string',
    ...
    },
    {
      ...
      type: 'number | boolean',
      description:
        'Badge indicator. A number shows a count badge. `true` shows a dot badge. `false` or `undefined` hides the badge.',
    },
    {
      name: 'disabled',
      type: 'boolean',
      default: 'false',
      description:
        'Whether the item is disabled (only applies to interactive items).',
    },
    {
      name: 'className',
      type: 'string',
    ...
    },
    {
      ...
      description:
        'Ref to the item element (HTMLButtonElement when clickable, HTMLSpanElement when static).',
    },
  ]}
/>
