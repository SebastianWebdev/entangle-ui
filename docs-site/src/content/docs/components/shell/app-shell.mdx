...
```tsx
<AppShell
  topChromeSeparator="shadow"
  sideChromeSeparator="none"
>
...
function ToggleToolbarButton() {
  ...
  return (
    <button onClick={() => setToolbarVisible('left', !isToolbarVisible('left'))}>
      Toggle Left Panel
    </button>
  );
}
...
<PropsTable props={[
  { name: 'viewportLock', type: 'boolean', default: 'false', description: 'Lock the shell to the viewport, preventing page scroll. Injects global html/body styles.' },
  { name: 'topChromeSeparator', type: "'none' | 'border' | 'shadow' | 'both'", default: "'border'", description: 'Visual separator under the top chrome area (menu + top toolbar).' },
  { name: 'sideChromeSeparator', type: "'none' | 'border' | 'shadow' | 'both'", default: "'border'", description: 'Visual separator between side toolbars and dock content.' },
  { name: 'children', type: 'ReactNode', description: 'Slot components (AppShell.MenuBar, AppShell.Toolbar, AppShell.Dock, AppShell.StatusBar).' },
...
<PropsTable props={[
  ...
  { name: 'style', type: 'CSSProperties', description: 'Inline styles.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
  { name: 'ref', type: 'Ref<HTMLElement>', description: 'Ref to the header element.' },
]} />

### AppShell.Toolbar

<PropsTable props={[
  { name: 'position', type: "'top' | 'left' | 'right'", default: "'top'", description: 'Toolbar placement in the layout. Side positions render as <aside> elements.' },
  { name: 'children', type: 'ReactNode', description: 'Toolbar content.' },
  { name: 'className', type: 'string', description: 'Additional CSS class names.' },
  { name: 'style', type: 'CSSProperties', description: 'Inline styles.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
  { name: 'ref', type: 'Ref<HTMLElement>', description: 'Ref to the toolbar element.' },
]} />
...
<PropsTable props={[
  ...
  { name: 'style', type: 'CSSProperties', description: 'Inline styles.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
  { name: 'ref', type: 'Ref<HTMLElement>', description: 'Ref to the main element.' },
]} />
...
<PropsTable props={[
  ...
  { name: 'style', type: 'CSSProperties', description: 'Inline styles.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
  { name: 'ref', type: 'Ref<HTMLElement>', description: 'Ref to the footer element.' },
]} />
