...
<Toolbar aria-label="Main toolbar">
  ...
  />
  <Toolbar.Spacer />
  <Toolbar.Button onClick={handleRender} variant="filled">Render</Toolbar.Button>
</Toolbar>
```
...
<Toolbar>
  ...
  <Toolbar.Button variant="filled" onClick={handlePlay}>Play</Toolbar.Button>
</Toolbar>
```
...
<Toolbar>
  ...
  <Toolbar.Group aria-label="View options">
    <Toolbar.Toggle pressed={ortho} onPressedChange={setOrtho} tooltip="Orthographic" icon={<OrthoIcon />} />
  </Toolbar.Group>
</Toolbar>
```
...
<PropsTable props={[
  { name: 'orientation', type: "'horizontal' | 'vertical'", default: "'horizontal'", description: 'Layout orientation. Arrow key navigation adapts to match.' },
  { name: 'size', type: "'sm' | 'md'", default: "'md'", description: 'Size of toolbar items.' },
  { name: 'children', type: 'ReactNode', description: 'Toolbar sub-components (Button, Toggle, Group, Separator, Spacer).' },
  { name: 'aria-label', type: 'string', description: 'Accessible label for the toolbar.' },
...
<PropsTable props={[
  { name: 'icon', type: 'ReactNode', description: 'Icon element to display. When provided, children text is visually hidden.' },
  { name: 'children', type: 'ReactNode', description: 'Label text. Hidden when an icon is provided.' },
  { name: 'variant', type: "'default' | 'ghost' | 'filled'", default: "'default'", description: 'Visual variant of the button.' },
  { name: 'tooltip', type: 'string', description: 'Tooltip text shown on hover (rendered as the native title attribute).' },
...
<PropsTable props={[
  { name: 'pressed', type: 'boolean', required: true, description: 'Whether the toggle is in the pressed state.' },
  { name: 'onPressedChange', type: '(pressed: boolean) => void', required: true, description: 'Called when the pressed state should change.' },
...
<PropsTable props={[
  { name: 'children', type: 'ReactNode', description: 'Grouped toolbar items.' },
  { name: 'aria-label', type: 'string', description: 'Accessible label for the group.' },
  { name: 'className', type: 'string', description: 'Additional CSS class names.' },
  { name: 'style', type: 'CSSProperties', description: 'Inline styles.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
  { name: 'ref', type: 'Ref<HTMLDivElement>', description: 'Ref to the group element.' },
]} />
...
<PropsTable props={[
  ...
  { name: 'style', type: 'CSSProperties', description: 'Inline styles.' },
  { name: 'testId', type: 'string', description: 'Test identifier for automated testing.' },
  { name: 'ref', type: 'Ref<HTMLDivElement>', description: 'Ref to the spacer element.' },
]} />
