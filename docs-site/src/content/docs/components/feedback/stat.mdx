---
title: Stat
description: KPI / metric display with label, value, optional trend delta, helper, and leading icon.
---
...
import StatDemo, {
  StatSizes,
  StatSemanticsPositive,
  StatSemanticsNegative,
  StatSemanticsNeutral,
  StatWithIcon,
  StatNoDelta,
  StatDashboard,
} from '../../../../components/demos/feedback/StatDemo';
...
<ComponentPreview title="Positive semantics">
  <StatSemanticsPositive client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Negative semantics">
  <StatSemanticsNegative client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Neutral semantics">
  <StatSemanticsNeutral client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="With icon">
  <StatWithIcon client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="No delta">
  <StatNoDelta client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Dashboard row">
  <StatDashboard client:only="react" />
</ComponentPreview>
  ...
  props={[
    {
      name: 'label',
      type: 'ReactNode',
      description: 'Label rendered above the value. Required.',
    },
    {
      name: 'value',
      type: 'ReactNode',
      description:
        'Primary value — pre-format on the consumer side (currency, units, locale). Required.',
    },
    {
      name: 'delta',
      type: 'StatDelta',
      description:
        'Optional trend delta. Shape: `{ value, direction, semantics? }`. See below.',
    },
    {
      name: 'helper',
      type: 'ReactNode',
      description:
        'Helper text below the delta (e.g. "vs. last month"). Optional.',
    },
    {
      name: 'icon',
      type: 'ReactNode',
      description: 'Leading icon rendered to the left of the content column.',
    },
    {
      name: 'size',
      type: "'sm' | 'md' | 'lg'",
      default: "'md'",
      description: 'Drives the value typography and overall density.',
    },
  ]}
/>
  ...
  props={[
    {
      name: 'value',
      type: 'ReactNode',
      description: 'Delta value to display (e.g. "+12.4%"). Required.',
    },
    {
      name: 'direction',
      type: "'up' | 'down' | 'neutral'",
      description: 'Direction of change — drives the arrow icon. Required.',
    },
    {
      name: 'semantics',
      ...
      default: "'positive'",
      description:
        'What the "up" direction means for this metric. `positive`: up is good (revenue, signups) — green for up, red for down. `negative`: up is bad (errors, latency) — red for up, green for down. `neutral`: show direction with muted colour, no judgement.',
    },
  ]}
/>
