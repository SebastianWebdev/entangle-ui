...
<PropsTable
  props={[
    ...
    },
    {
      ...
      default: "'100%'",
      description:
        'Width of the alert. Number → px, string → CSS value. Defaults to filling the parent so the alert keeps a stable width regardless of content length; long strings wrap inside.',
    },
    {
      name: 'children',
      type: 'ReactNode',
