...
```tsx
import { Dialog, DialogHeader, DialogBody, DialogFooter, DialogClose } from 'entangle-ui';
```
...
<PropsTable props={[
  ...
  { name: 'onClose', type: '() => void', description: 'Callback fired when the dialog should close.' },
  { name: 'size', type: "'sm' | 'md' | 'lg' | 'xl' | 'fullscreen'", default: "'md'", description: 'Dialog width preset.' },
  { name: 'title', type: 'string', description: 'Dialog title for aria-labelledby (hidden, use DialogHeader for visible title).' },
  { name: 'description', type: 'string', description: 'Dialog description for aria-describedby.' },
  { name: 'closeOnOverlayClick', type: 'boolean', default: 'true', description: 'Whether clicking the overlay closes the dialog.' },
  { name: 'closeOnEscape', type: 'boolean', default: 'true', description: 'Whether pressing Escape closes the dialog.' },
  { name: 'showOverlay', type: 'boolean', default: 'true', description: 'Whether to show the overlay backdrop.' },
  { name: 'trapFocus', type: 'boolean', default: 'true', description: 'Whether to trap focus within the dialog.' },
  { name: 'initialFocusRef', type: 'RefObject<HTMLElement>', description: 'Ref to the element that should receive initial focus.' },
  { name: 'portal', type: 'boolean', default: 'true', description: 'Whether to render the dialog in a portal (document.body).' },
  { name: 'children', type: 'ReactNode', description: 'Dialog content (DialogHeader, DialogBody, DialogFooter).' },
  { name: 'className', type: 'string', description: 'Additional CSS class names for the dialog panel.' },
  { name: 'style', type: 'CSSProperties', description: 'Inline styles for the dialog panel.' },
  ...
  { name: 'ref', type: 'Ref<HTMLDivElement>', description: 'Ref to the dialog panel element.' },
]} />

### DialogHeader

<PropsTable props={[
  { name: 'children', type: 'ReactNode', description: 'Header content (typically a title string).' },
  { name: 'showClose', type: 'boolean', description: 'Whether to show the close button.' },
...
<PropsTable props={[
  { name: 'children', type: 'ReactNode', description: 'Footer content (typically action buttons).' },
  { name: 'align', type: "'left' | 'center' | 'right' | 'space-between'", description: 'Horizontal alignment of footer content.' },
  { name: 'className', type: 'string', description: 'Additional CSS class names.' },
]} />
