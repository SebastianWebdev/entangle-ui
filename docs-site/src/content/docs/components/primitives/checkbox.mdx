...
<PropsTable props={[
  { name: 'checked', type: 'boolean', description: 'Whether the checkbox is checked (controlled mode).' },
  { name: 'defaultChecked', type: 'boolean', default: 'false', description: 'Default checked state (uncontrolled mode).' },
  { name: 'indeterminate', type: 'boolean', default: 'false', description: 'Whether the checkbox is in an indeterminate state. Shows a dash icon.' },
  { name: 'label', type: 'string', description: 'Label text displayed next to the checkbox.' },
  { name: 'labelPosition', type: "'left' | 'right'", default: "'right'", description: 'Position of the label relative to the checkbox.' },
  { name: 'size', type: "'sm' | 'md' | 'lg'", default: "'md'", description: 'Checkbox size.' },
  { name: 'variant', type: "'default' | 'filled'", default: "'default'", description: 'Visual variant controlling unchecked/checked appearance.' },
  ...
  { name: 'error', type: 'boolean', default: 'false', description: 'Whether the checkbox has an error state.' },
  ...
  { name: 'value', type: 'string', description: 'Value attribute for CheckboxGroup integration and form submission.' },
  { name: 'name', type: 'string', description: 'Name attribute for form submission.' },
  { name: 'onChange', type: '(checked: boolean) => void', description: 'Change event handler receiving the new checked state.' },
