...
<PropsTable props={[
  { name: 'children', type: 'ReactNode', description: 'Icon component to display inside the button.' },
  { name: 'aria-label', type: 'string (required)', description: 'Accessible label for screen readers. Required for proper accessibility.' },
  { name: 'variant', type: "'default' | 'ghost' | 'filled'", default: "'ghost'", description: 'Visual variant of the button.' },
  { name: 'size', type: "'sm' | 'md' | 'lg'", default: "'md'", description: 'Button size. The button is always square.' },
  { name: 'radius', type: "'none' | 'sm' | 'md' | 'lg' | 'full'", default: "'md'", description: 'Border radius for button shape control.' },
  { name: 'disabled', type: 'boolean', default: 'false', description: 'Whether the button is disabled.' },
  { name: 'loading', type: 'boolean', default: 'false', description: 'Loading state -- shows spinner and disables interaction.' },
  { name: 'pressed', type: 'boolean', default: 'false', description: 'Whether the button appears pressed/active. Sets aria-pressed.' },
