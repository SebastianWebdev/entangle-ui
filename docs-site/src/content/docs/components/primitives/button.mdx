...
<ComponentPreview title="default" description="Transparent with border, fills on hover. Use for secondary actions.">
```tsx
<Button variant="default">Default</Button>
```
</ComponentPreview>

<ComponentPreview title="ghost" description="No border, subtle hover state. Use for inline or low-emphasis actions.">
```tsx
<Button variant="ghost">Ghost</Button>
```
</ComponentPreview>

<ComponentPreview title="filled" description="Solid background with accent color. Use for primary actions.">
```tsx
...
```tsx
<Button variant="filled" fullWidth>Confirm Action</Button>
```
...
<PropsTable props={[
  ...
  { name: 'size', type: "'sm' | 'md' | 'lg'", default: "'md'", description: 'Size variant optimized for editor interfaces.' },
  { name: 'disabled', type: 'boolean', default: 'false', description: 'Whether the button is disabled.' },
  { name: 'loading', type: 'boolean', default: 'false', description: 'Loading state — shows spinner and disables interaction.' },
  { name: 'icon', type: 'ReactNode', description: 'Icon element to display before text. Should be 16x16px.' },
  { name: 'fullWidth', type: 'boolean', default: 'false', description: 'Whether the button should take the full width of the container.' },
