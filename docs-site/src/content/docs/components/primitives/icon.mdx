...
<PropsTable props={[
  { name: 'children', type: 'ReactNode', description: 'SVG content (paths, circles, etc.) to render inside the icon.' },
  { name: 'size', type: "'sm' | 'md' | 'lg'", default: "'md'", description: 'Icon size controlling width and height.' },
  { name: 'color', type: "'primary' | 'secondary' | 'muted' | 'accent' | 'success' | 'warning' | 'error' | string", default: "'primary'", description: 'Icon color. Standard theme tokens or any CSS color value.' },
  { name: 'title', type: 'string', description: 'Accessible title for the icon. Renders a <title> element inside the SVG.' },
  { name: 'decorative', type: 'boolean', default: 'false', description: 'Whether the icon is decorative only. Sets aria-hidden and role=presentation.' },
  ...
  { name: 'ref', type: 'Ref<SVGSVGElement>', description: 'Ref to the underlying SVG element.' },
]} />
