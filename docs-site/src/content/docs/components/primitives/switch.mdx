...
import SwitchDemo from '../../../../components/demos/primitives/SwitchDemo';
...
<PropsTable
  props={[
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Default on/off state (uncontrolled mode).',
    },
    ...
    },
    {
      ...
      type: "'sm' | 'md' | 'lg'",
      default: "'md'",
      description: 'Switch size controlling track and thumb dimensions.',
    },
    {
      name: 'disabled',
      type: 'boolean',
    ...
    },
    {
      ...
      description: 'Change event handler receiving the new on/off state.',
    },
    {
      name: 'className',
      type: 'string',
