...
import PaperDemo from '../../../../components/demos/primitives/PaperDemo';
  ...
  props={[
    {
      name: 'children',
      type: 'ReactNode',
      description: 'Paper content -- any React elements.',
    },
    {
      name: 'elevation',
      type: '0 | 1 | 2 | 3',
      default: '1',
      description: 'Shadow intensity level for visual depth.',
    },
    {
      name: 'bordered',
      type: 'boolean',
      default: 'false',
      description: 'Whether to show a subtle border around the paper.',
    },
    {
      name: 'padding',
    ...
    },
    {
      ...
      default: '0',
      description:
        'Nesting level for automatic background brightness adjustment.',
    },
    {
      name: 'expand',
      type: 'boolean',
      default: 'false',
      description: 'Whether the paper should fill available width and height.',
    },
    {
      name: 'customRadius',
      type: 'string | number',
      description:
        'Custom border radius override. Numbers are treated as pixels.',
    },
    {
      name: 'className',
      type: 'string',
