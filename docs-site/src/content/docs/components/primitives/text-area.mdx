...
import TextAreaDemo, {
  ...
  TextAreaError,
  TextAreaDisabled,
} from '../../../../components/demos/primitives/TextAreaDemo';
...
<ComponentPreview
  title="Controlled"
  description="Typing updates parent state, which drives both the field and the character counter below it."
>
  <TextAreaControlled client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Sizes">
  <TextAreaSizes client:only="react" />
</ComponentPreview>
...
<ComponentPreview
  title="Auto-resize"
  description="Press Enter a few times — the textarea grows until it hits 6 rows, then scrolls."
>
  <TextAreaAutoResize client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Character count">
  <TextAreaWithCharCount client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Monospace">
  <TextAreaMonospace client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Error state">
  <TextAreaError client:only="react" />
</ComponentPreview>
...
<ComponentPreview title="Disabled and read-only">
  <TextAreaDisabled client:only="react" />
</ComponentPreview>
