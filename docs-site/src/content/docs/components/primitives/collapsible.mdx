...
<PropsTable props={[
  { name: 'trigger', type: 'ReactNode', description: 'Content shown in the collapsible header/trigger.' },
  { name: 'children', type: 'ReactNode', description: 'Content to render when expanded.' },
  { name: 'open', type: 'boolean', description: 'Whether the section is expanded (controlled mode).' },
  { name: 'defaultOpen', type: 'boolean', default: 'false', description: 'Default expanded state (uncontrolled mode).' },
  { name: 'size', type: "'sm' | 'md' | 'lg'", default: "'sm'", description: 'Size controlling header height, padding, and font size.' },
  { name: 'indicator', type: 'ReactNode | null', description: 'Custom indicator icon. Defaults to a chevron. Set to null to hide.' },
  { name: 'disabled', type: 'boolean', default: 'false', description: 'Whether the collapsible is disabled.' },
  { name: 'keepMounted', type: 'boolean', default: 'false', description: 'Whether to keep content in the DOM when collapsed.' },
  { name: 'onChange', type: '(open: boolean) => void', description: 'Callback when the open state changes.' },
