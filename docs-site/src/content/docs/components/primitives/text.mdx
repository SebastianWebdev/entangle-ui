...
import TextDemo from '../../../../components/demos/primitives/TextDemo';
...
<PropsTable
  props={[
    ...
    {
      name: 'as',
      type: "'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6' | 'p' | 'span' | 'div' | 'label' | 'strong' | 'em' | 'small'",
      default: "'span'",
      description: 'HTML element to render as.',
    },
    {
      name: 'variant',
      type: "'display' | 'heading' | 'subheading' | 'body' | 'caption' | 'code' | 'inherit'",
      default: "'body'",
    ...
    },
    {
      ...
      type: "'xs' | 'sm' | 'md' | 'lg' | 'xl'",
      description:
        'Text size using theme typography tokens. Overrides variant size.',
    },
    {
      name: 'weight',
      type: "'normal' | 'medium' | 'semibold'",
      description:
        'Text weight using theme typography tokens. Overrides variant weight.',
    },
    {
      name: 'color',
      type: "'primary' | 'secondary' | 'muted' | 'disabled' | 'accent' | 'success' | 'warning' | 'error'",
      default: "'primary'",
    ...
    },
    {
      ...
      description: 'Line height. Overrides variant line height.',
    },
    {
      name: 'align',
    ...
    },
    {
      name: 'maxLines',
      type: 'number',
      description: 'Maximum lines before truncating. Requires truncate=true.',
    },
    {
      name: 'nowrap',
      type: 'boolean',
      default: 'false',
      description: 'Whether text should not wrap to the next line.',
    },
    {
      name: 'mono',
      type: 'boolean',
      default: 'false',
      description:
        'Whether to use monospace font family. Automatically true for code variant.',
    },
    {
      name: 'className',
      type: 'string',
    ...
    },
    {
      ...
      description: 'Ref to the underlying HTML element.',
    },
  ]}
/>
