...
<PropsTable
  props={[
    ...
    },
    {
      name: 'emptyState',
      type: 'ReactNode',
      description: 'Empty state slot or text. Rendered when `rows.length === 0`.',
    },
    {
      name: 'loading',
      type: 'boolean',
    ...
    },
    {
      ...
      type: 'number',
      description: 'Estimated row height in px. Defaults to a density-dependent value.',
    },
    {
      name: 'overscan',
      type: 'number',
    ...
    },
    {
      name: 'maxHeight',
      type: 'number | string',
      description: 'Maximum height before scroll engages (non-virtualized mode).',
    },
    {
...
<PropsTable
  props={[
    ...
    },
    {
      name: 'minWidth',
      type: 'number',
      description: 'Minimum column width in px (used for resizing and as the grid floor).',
    },
    {
      name: 'maxWidth',
      type: 'number',
    ...
    },
    {
      name: 'sticky',
      type: 'boolean',
      description: 'When true, this column sticks to the left edge while scrolling.',
    },
    {
      name: 'ariaHidden',
      type: 'boolean',
      description: 'When true, the column header is not focusable for keyboard users.',
    },
    {
      name: 'disableResize',
      type: 'boolean',
      description: 'When true, this column cannot be resized even if `resizableColumns` is on.',
    },
  ]}
/>
