...
import VectorInputDemo from '../../../../components/demos/controls/VectorInputDemo';
...
<ComponentPreview title="Live Preview">
  <VectorInputDemo client:only="react" />
</ComponentPreview>
  ...
  props={[
    {
      ...
      type: 'number[]',
      description:
        'Current vector value (controlled). Array length must match dimension.',
    },
    {
      name: 'defaultValue',
      type: 'number[]',
      description: 'Default vector value (uncontrolled).',
    },
    {
      name: 'dimension',
      type: '2 | 3 | 4',
    ...
    {
      name: 'labelPreset',
      type: "'xyz' | 'rgba' | 'uvw' | 'custom'",
      default: "'xyz'",
      description: 'Axis label preset configuration.',
    },
    {
      name: 'axisLabels',
      type: 'string[]',
      description: 'Custom axis labels (when labelPreset is "custom").',
    },
    {
      name: 'colorPreset',
      type: "'spatial' | 'color' | 'none' | 'custom'",
      default: "'spatial'",
      description: 'Color coding preset for axis labels.',
    },
    {
      name: 'axisColors',
      type: 'string[]',
      description:
        'Custom axis colors (when colorPreset is "custom"). CSS color strings.',
    },
    {
      name: 'min',
      type: 'number',
      description: 'Minimum allowed value (applies to all axes).',
    },
    {
      name: 'max',
      type: 'number',
      description: 'Maximum allowed value (applies to all axes).',
    },
    {
      name: 'step',
      type: 'number',
    ...
    },
    {
      name: 'unit',
      type: 'string',
      description: 'Unit suffix displayed in each input (e.g., "px", "deg").',
    },
    {
      name: 'size',
      type: "'sm' | 'md' | 'lg'",
    ...
    },
    {
      name: 'label',
      type: 'string',
      description: 'Label displayed above the vector input.',
    },
    {
      name: 'helperText',
      type: 'string',
    ...
    { name: 'errorMessage', type: 'string', description: 'Error message.' },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Whether the vector input is disabled.',
    },
    {
      name: 'showLink',
      type: 'boolean',
      default: 'false',
      description: 'Whether to show the link/unlink proportions toggle.',
    },
    {
      name: 'defaultLinked',
      type: 'boolean',
      default: 'false',
      description: 'Whether axes are linked by default (uncontrolled).',
    },
    {
      name: 'linked',
      type: 'boolean',
      description: 'Whether axes are linked (controlled).',
    },
    {
      name: 'onLinkedChange',
      type: '(linked: boolean) => void',
      description: 'Callback when the linked state changes.',
    },
    {
      name: 'direction',
      type: "'row' | 'column'",
      default: "'row'",
      description: 'Layout direction of axis inputs.',
    },
    {
      name: 'gap',
      type: 'number',
      default: '2',
      description: 'Gap between axis inputs in pixels.',
    },
    {
      name: 'onChange',
      type: '(value: number[], axisIndex: number) => void',
      description: 'Callback when any axis value changes.',
    },
    {
      name: 'onChangeComplete',
      type: '(value: number[]) => void',
      description: 'Callback when editing is committed (blur, Enter).',
    },
    {
      name: 'className',
      type: 'string',
