...
<PropsTable props={[
  ...
  { name: 'onChange', type: '(value: number) => void', description: 'Callback when value changes.', required: true },
  ...
  { name: 'precisionStep', type: 'number', default: 'step / 10', description: 'Step size when Shift is held (fine control).' },
  { name: 'largeStep', type: 'number', default: 'step * 10', description: 'Step size when Ctrl/Cmd is held (coarse control).' },
  { name: 'precision', type: 'number', default: '2', description: 'Number of decimal places to round to.' },
  ...
  { name: 'readOnly', type: 'boolean', default: 'false', description: 'Whether the slider is read-only.' },
  { name: 'label', type: 'string', description: 'Label text displayed above the slider.' },
  { name: 'helperText', type: 'string', description: 'Helper text displayed below the slider.' },
  { name: 'error', type: 'boolean', default: 'false', description: 'Whether the slider has an error state.' },
  { name: 'errorMessage', type: 'string', description: 'Error message displayed when error is true.' },
  { name: 'required', type: 'boolean', default: 'false', description: 'Whether the slider is required.' },
  { name: 'unit', type: 'string', description: 'Unit suffix to display (e.g., "px", "%", "°").' },
  { name: 'formatValue', type: '(value: number) => string', description: 'Custom value formatter for display.' },
  { name: 'showTooltip', type: 'boolean', default: 'true', description: 'Show value tooltip while dragging.' },
  { name: 'showTicks', type: 'boolean', default: 'false', description: 'Show tick marks along the track.' },
