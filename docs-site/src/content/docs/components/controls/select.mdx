...
<PropsTable props={[
  { name: 'value', type: 'T | null', description: 'Selected value (controlled).' },
  { name: 'defaultValue', type: 'T', description: 'Default selected value (uncontrolled).' },
  { name: 'options', type: 'Array<SelectOptionItem<T> | SelectOptionGroup<T>>', description: 'Options to display — flat list or grouped.' },
  { name: 'placeholder', type: 'string', default: "'Select...'", description: 'Placeholder text when no value is selected.' },
  { name: 'searchable', type: 'boolean', default: 'false', description: 'Whether to show a search input inside the dropdown.' },
  { name: 'searchPlaceholder', type: 'string', default: "'Search...'", description: 'Placeholder for the search input.' },
  { name: 'filterFn', type: '(option: SelectOptionItem<T>, query: string) => boolean', description: 'Custom filter function for searchable mode.' },
  { name: 'emptyMessage', type: 'string', default: "'No results found'", description: 'Message shown when search yields no results.' },
  { name: 'size', type: "'sm' | 'md' | 'lg'", default: "'md'", description: 'Size of the trigger button.' },
  { name: 'variant', type: "'default' | 'ghost' | 'filled'", default: "'default'", description: 'Visual variant of the trigger button.' },
  ...
  { name: 'clearable', type: 'boolean', default: 'false', description: 'Whether a clear button appears when a value is selected.' },
  { name: 'maxDropdownHeight', type: 'number', default: '240', description: 'Maximum height of the dropdown in pixels.' },
  { name: 'minDropdownWidth', type: 'number', description: 'Minimum width of the dropdown in pixels.' },
  { name: 'name', type: 'string', description: 'Name attribute for hidden input (form submission).' },
  { name: 'onChange', type: '(value: T | null) => void', description: 'Callback when the selected value changes.' },
