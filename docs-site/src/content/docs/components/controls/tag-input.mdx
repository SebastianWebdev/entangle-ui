...
<PropsTable
  props={[
    ...
    },
    {
      name: 'max',
      type: 'number',
      description: 'Maximum number of tags. When reached the input is disabled.',
    },
    {
      name: 'validate',
    ...
    },
    {
      ...
      description: 'Custom chip renderer. When omitted the built-in chip is used.',
    },
    {
      name: 'size',
      type: "'sm' | 'md' | 'lg'",
    ...
    },
    {
      name: 'errorMessage',
      type: 'string',
      description: 'Error message — shown in place of `helperText` when `error` is true.',
    },
    {
      name: 'disabled',
      type: 'boolean',
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Read-only — chips are visible but not removable, input is hidden.',
    },
    {
      name: 'name',
      type: 'string',
