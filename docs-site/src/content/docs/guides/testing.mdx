---
title: Testing
description: How to test an application built with Entangle UI — Vitest + jsdom setup, loading the theme so CSS variables resolve, and stubbing the browser observers that editor components rely on.
---
