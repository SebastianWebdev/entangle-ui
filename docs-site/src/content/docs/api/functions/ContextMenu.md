...
> **ContextMenu**\<`TPayload`\>(`__namedParameters`): `Element`

Defined in: [src/components/navigation/ContextMenu/ContextMenu.tsx:15](https://github.com/SebastianWebdev/entangle-ui/blob/3a4ec9f4fea9c67f55f22d9132b3047d3a5027ac/src/components/navigation/ContextMenu/ContextMenu.tsx#L15)
...
[`ContextMenuConfig`](/api/type-aliases/contextmenuconfig/)\<`TPayload`\>
