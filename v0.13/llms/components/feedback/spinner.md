...
| `decorative` | `boolean` | `false` | Render as purely decorative (role="presentation" + aria-hidden, no live region). Use when nested inside an existing live region such as StatusBar. |
